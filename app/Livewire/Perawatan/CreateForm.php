...
class CreateForm extends Component
{
    ...
    private function validateCurrentStep(): bool
    {
        $rules = match ($this->currentStep) {
            ...
            6 => ['kondisiAkhir' => 'required|in:good,fair,critical,poor'],
            default => null,
        };
    ...
    {
        return match (true) {
            str_starts_with($attribute, 'hardwareItems') => 3,
            str_starts_with($attribute, 'aplikasiItems') => 4,
            str_starts_with($attribute, 'osItems') => 5,
            $attribute === 'penggunaId' => 1,
            in_array($attribute, ['assetId', 'siteLocation'], true) => 2,
            $attribute === 'kondisiAkhir' => 6,
            default => 8,
        };
    }
    ...
    private function labelForAttribute(string $attribute): string
    {
        return match ($attribute) {
            ...
            'siteLocation' => 'Site Location Perawatan',
            'kondisiAkhir' => 'Kondisi Setelah Perawatan',
    ...
    public function submitForm(): void
    {
        ...
        try {
            ...
            $existing = $isNew ? null : FormPerawatan::with('approvals')->findOrFail($this->formId);
