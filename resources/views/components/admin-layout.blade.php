            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex flex-col lg:flex-row gap-6">
                    ...
                    <aside class="w-full lg:w-56 shrink-0">
                        <div class="glass-card p-2 lg:sticky lg:top-24">
                            <div class="px-3 py-2 mb-1">
                                <h2 class="text-sm font-bold text-primary">{{ __('Admin Panel') }}</h2>
                            </div>
                            <nav class="flex gap-1.5 overflow-x-auto pb-1 lg:block lg:space-y-0.5 lg:overflow-visible lg:pb-0">
                                <a href="{{ route('admin.dashboard') }}"
                                    class="shrink-0 whitespace-nowrap flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 {{ request()->routeIs('admin.dashboard') ? 'admin-nav-active' : '' }}"
                                ...
                                @if(auth()->user()->hasRole('admin'))
                                    <a href="{{ route('admin.sites.index') }}" wire:navigate
                                        class="shrink-0 whitespace-nowrap flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 {{ request()->routeIs('admin.sites.*') ? 'admin-nav-active' : '' }}"
                                    ...
                                    <a href="{{ route('admin.users.index') }}" wire:navigate
                                        class="shrink-0 whitespace-nowrap flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 {{ request()->routeIs('admin.users.*') ? 'admin-nav-active' : '' }}"
                                ...
                                <a href="{{ route('admin.employees.index') }}" wire:navigate
                                    class="shrink-0 whitespace-nowrap flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 {{ request()->routeIs('admin.employees.*') ? 'admin-nav-active' : '' }}"
                                ...
                                @if(auth()->user()->hasRole('admin'))
                                    <a href="{{ route('admin.structure-organization.index') }}" wire:navigate
                                        class="shrink-0 whitespace-nowrap flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 {{ request()->routeIs('admin.structure-organization.*') ? 'admin-nav-active' : '' }}"
                                ...
                                <a href="{{ route('admin.assets.index') }}" wire:navigate
                                    class="shrink-0 whitespace-nowrap flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 {{ request()->routeIs('admin.assets.*') ? 'admin-nav-active' : '' }}"
                                ...
                                <div class="hidden lg:block pt-2 pb-1 px-3">
                                ...
                                <a href="{{ route('admin.pemeriksaan.index') }}" wire:navigate
                                    class="shrink-0 whitespace-nowrap flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 {{ request()->routeIs('admin.pemeriksaan.*') ? 'admin-nav-active' : '' }}"
                                ...
                                <a href="{{ route('admin.perawatan.index') }}" wire:navigate
                                    class="shrink-0 whitespace-nowrap flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 {{ request()->routeIs('admin.perawatan.*') ? 'admin-nav-active' : '' }}"
                                ...
                                <a href="{{ route('admin.pengembalian.index') }}" wire:navigate
                                    class="shrink-0 whitespace-nowrap flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 {{ request()->routeIs('admin.pengembalian.*') ? 'admin-nav-active' : '' }}"
                                ...
                                @if(auth()->user()->hasRole('admin'))
                                    <a href="{{ route('admin.backup.index') }}" wire:navigate
                                        class="shrink-0 whitespace-nowrap flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 {{ request()->routeIs('admin.backup.*') ? 'admin-nav-active' : '' }}"
                                ...
                                <a href="{{ route('admin.activity-log.index') }}" wire:navigate
                                    class="shrink-0 whitespace-nowrap flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 {{ request()->routeIs('admin.activity-log.*') ? 'admin-nav-active' : '' }}"
                                ...
                                @if(auth()->user()->hasRole('admin'))
                                    <a href="{{ route('admin.system-log.index') }}" wire:navigate
                                        class="shrink-0 whitespace-nowrap flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 {{ request()->routeIs('admin.system-log.*') ? 'admin-nav-active' : '' }}"
