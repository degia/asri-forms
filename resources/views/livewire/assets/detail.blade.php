        ...
        <div class="flex items-start justify-between">
            ...
            <div class="flex items-center gap-2">
                @if (auth()->user()?->hasRole(['admin', 'teknisi']))
                    <a href="{{ route('pemeriksaan.create', ['assetId' => $asset->id]) }}" wire:navigate
                        class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-xs font-medium transition-colors duration-200 bg-blue-500/15 text-blue-400 hover:bg-blue-500/25">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                        {{ __('Form Pemeriksaan') }}
                    </a>
                    <a href="{{ route('perawatan.create', ['assetId' => $asset->id]) }}" wire:navigate
                        class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-xs font-medium transition-colors duration-200 bg-purple-500/15 text-purple-400 hover:bg-purple-500/25">
