                    ...
                    <table class="w-full text-xs">
                        <thead>
                            <tr class="border-b" style="border-color: var(--color-border);">
                                ...
                                <th class="px-3 py-2 text-left text-muted font-medium whitespace-nowrap">{{ __('Kondisi Akhir') }}</th>
                        ...
                        <tbody class="divide-y" style="border-color: var(--color-border);">
                            @foreach($preview as $i => $row)
                                <tr>
                                    ...
                                    <td class="px-3 py-2 text-secondary whitespace-nowrap">{{ $row['kondisi_akhir'] ?? '-' }}</td>
    ...
    @if($showConfirmModal)
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4" style="background: rgba(0,0,0,0.5); backdrop-filter: blur(4px);"
            ...
            <div class="glass-card p-6 w-full max-w-md space-y-4" @click.away="$wire.dismissConfirmImport()">
                ...
                <p class="text-sm text-muted">{{ __('Yakin ingin mengirim') }} <span class="font-semibold text-primary">{{ $successCount }} {{ __('form perawatan') }}</span> {{ __('ke database? Setelah dikirim, Anda akan diarahkan ke halaman Perawatan.') }}</p>
                <div class="flex gap-2">
