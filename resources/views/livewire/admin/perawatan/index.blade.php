                                ...
                                <td class="px-4 py-3 text-right">
                                    <div class="flex items-center justify-end gap-1">
                                        ...
                                        @if($form->status !== 'draft')
                                            <a href="{{ route('approval.show', ['type' => 'perawatan', 'id' => $form->id]) }}" wire:navigate
                                        ...
                                        @if(in_array($form->status, ['draft', 'submitted', 'diketahui']) && auth()->user()->hasRole('admin'))
                                            <a href="{{ route('perawatan.create', ['formId' => $form->id]) }}" wire:navigate
                                        ...
                                        @if($form->status === 'submitted' && $form->user_id === auth()->id() && !auth()->user()->hasRole('manager_it'))
                                            <a href="{{ route('perawatan.signature', $form->id) }}" wire:navigate
